...
- `PROTOCOL_VERSION` (`src/lib.rs:8`, currently 14) and `UnixSocketDaemonClient.protocolVersion` (`swift/AfterRayRecall/Sources/DaemonClient.swift`) must bump together — the Swift client hard-rejects any mismatch; there is no negotiation.
