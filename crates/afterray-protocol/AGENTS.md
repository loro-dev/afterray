...
- `PROTOCOL_VERSION` (`src/lib.rs:34`, currently 16) and `UnixSocketDaemonClient.protocolVersion` (`swift/AfterRayRecall/Sources/DaemonClient.swift`) must bump together — the Swift client hard-rejects any mismatch; there is no negotiation.
