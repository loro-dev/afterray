...
- [context/](context/) — navigation articles: [capture-pipeline](context/capture-pipeline.md), [event-capture-v2](context/event-capture-v2.md), [wire-protocol](context/wire-protocol.md), [agent-tools](context/agent-tools.md), [acts-join](context/acts-join.md); [CONTEXT-GAPS.md](context/CONTEXT-GAPS.md) — gaps backlog
