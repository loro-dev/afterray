...
- [context/](context/) — navigation articles: [capture-pipeline](context/capture-pipeline.md), [wire-protocol](context/wire-protocol.md), [agent-tools](context/agent-tools.md), [ocr-text-selection](context/ocr-text-selection.md); [CONTEXT-GAPS.md](context/CONTEXT-GAPS.md) — gaps backlog
