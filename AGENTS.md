...
- [context/](context/) — navigation articles: [capture-pipeline](context/capture-pipeline.md), [wire-protocol](context/wire-protocol.md), [compute-governance](context/compute-governance.md); [CONTEXT-GAPS.md](context/CONTEXT-GAPS.md) — gaps backlog
